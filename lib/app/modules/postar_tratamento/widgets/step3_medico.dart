              ...
              : controller.questoesPreCadastradas.isEmpty
                  ...
                  : IgnorePointer(
                      ...
                      child: DropdownSearch<Questao>(
                        ...
                        dropdownBuilder: (_, vinculo) => const AutoSizeText(
                                    ...
                                    : IconButton(
                                        onPressed: () {
                                          showDialog(
                                            ...
                                            controller
                                                .setIsQuestoesUntouched(false);
                                            Get.find<ControllerQuestoes>()
                                                .clearFields();
                                          });
                                        },
                                        icon: const Icon(
                                ...
                                ? ListTile(
                                    ...
                                    title: AutoSizeText(
                                        controller.questoes[index].descricao ??
                                            '',
                                        maxLines: 1),
                                    trailing: controller.questoes[index].id ==
                                                1 ||
                                            controller.questoes[index].id == 2
                                        ? Container()
                                        : rowBotoes,
                                  )
                                : ExpansionTile(
