...
import 'package:healthbox/app/modules/acompanhamentos/widgets/item_grid_usuarios_acompanhamentos.dart';
import 'package:healthbox/app/modules/acompanhamentos/widgets/shimmer_usuarios_acompanhamentos.dart';
import 'package:responsive_framework/responsive_framework.dart';

class GridUsuariosAcompanhamentos extends GetView<AcompanhamentosController> {
  const GridUsuariosAcompanhamentos({Key? key}) : super(key: key);
          ...
          : controller.usuariosAcompanhamentos.isEmpty
              ...
              : GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return ItemGridUsuariosAcompanhamentos(
                      index: index,
                    );
                  }),
    );
