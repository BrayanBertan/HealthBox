        ...
        () => TableCalendar<Questionario>(
          ...
          calendarBuilders: CalendarBuilders(
            ...
            selectedBuilder: (_, data, proximoDia) => TableCalendarBuilders(
                ...
                itemValue: data.day,
                boxDecoration:
                    BoxDecoration(shape: BoxShape.circle, color: corPrincipal),
                width: 35.0,
                height: 35.0),
            todayBuilder: (_, data, proximoDia) => TableCalendarBuilders(
                textStyle:
                    TextStyle(color: corPrincipal, fontWeight: FontWeight.bold),
                itemValue: data.day,
                boxDecoration: const BoxDecoration(color: Colors.transparent),
                width: 35.0,
                height: 35.0),
          ...
          onDaySelected: (date, date1) => controller.setQuestionariosDia(date),
